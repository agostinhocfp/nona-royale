...
namespace NonaRoyale.Unity.View
{
    ...
    public static class OperatorLookBook
    {
        ...
        private static LookBookPalette BuildPalette() => new LookBookPalette
        {
            ...
            KurbynCloth = F(UiTheme.LookKurbynCloth),
            KurbynSkin = F(UiTheme.LookKurbynSkin),
            JaviWaistcoat = F(UiTheme.LookJaviWaistcoat),
            JaviGlove = F(UiTheme.LookJaviGlove),
            JaviHair = F(UiTheme.LookJaviHair),
            JaviSkin = F(UiTheme.LookJaviSkin),
            JaviSteel = F(UiTheme.LookJaviSteel),
            JaviFrost = F(UiTheme.LookJaviFrost),
            SanityApron = F(UiTheme.LookSanityApron),
            SanityLivery = F(UiTheme.LookSanityLivery),
            SanitySkin = F(UiTheme.LookSanitySkin),
            SanitySteel = F(UiTheme.LookSanitySteel),
            ...
            RevuJacket = F(UiTheme.LookRevuJacket),
            RevuTrousers = F(UiTheme.LookRevuTrousers),
            RevuHair = F(UiTheme.LookRevuHair),
            RevuSkin = F(UiTheme.LookRevuSkin),
            KianJacket = F(UiTheme.LookKianJacket),
            KianShirt = F(UiTheme.LookKianShirt),
            KianSkin = F(UiTheme.LookKianSkin),
            LukaBlazer = F(UiTheme.LookLukaBlazer),
            LukaShirt = F(UiTheme.LookLukaShirt),
            LukaSkin = F(UiTheme.LookLukaSkin),
            FortunaCloth = F(UiTheme.LookFortunaCloth),
            FortunaShirt = F(UiTheme.LookFortunaShirt),
            FortunaSkin = F(UiTheme.LookFortunaSkin),
            FortunaHair = F(UiTheme.LookFortunaHair),
            FortunaGold = F(UiTheme.LookFortunaGold),
            FortunaGoldLight = F(UiTheme.LookFortunaGoldLight),
            LetheGown = F(UiTheme.LookLetheGown),
            LetheGlove = F(UiTheme.LookLetheGlove),
            LetheSilver = F(UiTheme.LookLetheSilver),
            LetheSkin = F(UiTheme.LookLetheSkin),
            LetheHair = F(UiTheme.LookLetheHair),
