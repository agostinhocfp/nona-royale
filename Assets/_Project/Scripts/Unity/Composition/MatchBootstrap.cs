...
namespace NonaRoyale.Unity.Composition
{
    ...
    {
        [Header("Match")]
        [Tooltip("Compact was withdrawn in ADR-0002 Amendment 4 — it moved pieces " +
                 "across half the loop per turn. Kept switchable for comparison only. " +
                 "Now 28x2: 24 is not a drawable cross (Amendment 5).")]
        public bool useCompactBoard = false;
