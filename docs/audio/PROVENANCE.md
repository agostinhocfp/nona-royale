...
| --- | --- | --- | --- | --- | --- |
| `Audio/Resources/Audio/Music/Match.ogg` | `Match.wav` (formerly `Big Band Version.wav`) | 2026-09-16 | _TBD_ | `MUSIC_PROMPTS.md` §1, Variant B (to confirm) | **AU4 (2026-09-21): the full take**, 0.02–157.97 s, 10 ms fade-in, 0.5 s fade-out, 48→44.1 kHz, −16 LUFS, peaks ≤ −1.5 dBFS (limiter, 0.4 dB), then Vorbis q7 (~200 kb/s). Was the loop 36.97–79.63 s (AU1c) |
| `Audio/Resources/Audio/Music/Match_2.ogg` | `Match_2.wav` | 2026-09-16 | _TBD_ | _to confirm_ | AU4: full take 0.00–177.15 s, same chain; limiter 2.6 dB on peaks |
| `Audio/Resources/Audio/Music/Match_3.ogg` | `Match_3.wav` (same file as `Sicilian Noir (4_4 Meter).wav`) | 2026-09-16 | _TBD_ | _to confirm_ | AU4: full take 0.02–158.01 s, same chain; limiter 0.3 dB |
| `Audio/Resources/Audio/Music/Match_4.ogg` | `Match_4.wav` (same file as `Title.wav`, the title's source take) | 2026-09-16 | _TBD_ | _to confirm_ | AU4: full take 0.34–151.91 s, same chain; −3.2 dB of gain, no limiting |
| `Audio/Resources/Audio/Music/Match_5.ogg` | `Match_5.wav` (same file as `Sicilian Waltz.wav`) | 2026-09-16 | _TBD_ | _to confirm_ | AU4: full take 0.07–176.74 s, same chain; limiter 1.4 dB |
