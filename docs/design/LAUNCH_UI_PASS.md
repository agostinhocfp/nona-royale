...
> Status: **Open, 2026-09-26.** G6a–G6e passed Play Mode. **G7 (the remaining screens): audit written from seven captures; G7a written and compile-checked, waiting on Play Mode; G7b proposed.** No decisions open.
