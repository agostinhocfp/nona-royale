...
- **Collected as the debtor ends its own turn**, before its statuses expire. The pool pays what it can and **the energy is destroyed, not transferred** (designer). An unpaid remainder draws **`DebtInterest` = 1**, once, never past the cap. A seat that pays in full is square and owes nobody.
  - **Why at the end of the debtor's turn and not at its upkeep:** a debt run up on an opponent's turn is then paid from what the seat chose to keep after a whole turn of its own, income included — paying or spending is a decision made with the bill in view. At upkeep the first payment would come out of a pool spent before the debt existed.
...
> **The punishment web, run as a loan book** (2026-09-24). His basic ability puts the target's seat in debt, paid from its pool as its turn ends or carried with interest; his ultimate collects what is owed; his passive makes the cheap answers to him the dangerous ones. **Bouncer's shape:** two actives with a named passive in the middle slot, ids 1101 and 1102. The draft planned 1101–1103 under the operator-number scheme; Fuse and Ghost's planned ids are now Luka's and Lethe's.

| #   | Ability         | Type         | Cost | CD  | Range | Effect                                                                                                                                           |
| --- | --------------- | ------------ | ---- | --- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1   | **Leech Round** | Active       | 3    | 1   | 3     | **2 Normal**; the target's seat takes on **2 debt** (§3.3), collected as it ends its turn.                                                         |
...
**Why she is not broken, in the rules rather than in the numbers.** The race polices the passive. She cannot defend herself — seven health, 1.0×, no shield, no ward, no escape, no cleanse, the only operator with three abilities and no answer to anybody walking up to her. Her bank meets Revú's book: his debt is paid out of exactly what she manufactures, so the two money operators still meet by construction — though since the 2026-09-24 rework a full bank pays his bill rather than inviting his ultimate. And nothing she does is hidden.
