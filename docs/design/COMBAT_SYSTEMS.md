...
| #   | Ability          | Type         | Cost | CD  | Range | Effect                                                                                                                                                                                                                              |
| --- | ---------------- | ------------ | ---- | --- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | **Blind Spot**   | Active       | 5    | 3   | 3     | **Teleport** to the enemy (§7.6 landing, no path damage); **2 Normal**, **3** if its max HP is above 7. **Follow-up** (§6.5): at Luka's next upkeep, if he is within **2** of the target, **1 Normal** — **2** if its max HP is above 7. Hunted marker; cleansable. |
