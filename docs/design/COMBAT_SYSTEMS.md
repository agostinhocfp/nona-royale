...
| 3   | **Eris' Exploit** | Active  | 6    | 4   | 3 (cell)   | **Zone, radius 2** (ADR-0007). **On the cast, and again at Lethe's next upkeep**, **each enemy inside takes 1 Normal for every other enemy inside**, as a single hit. One enemy inside takes nothing. Kills credit Lethe. |
